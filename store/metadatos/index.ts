...
export interface IMetadatatosActions {
	...
	postMetadato: (data: IMetadatosState, router?: NextRouter) => Promise<void>;
	patchMetadato: (data: IMetadatosState, router?: NextRouter) => Promise<void>;
	...
	postTemporal: (data: IMetadatosState, router?: NextRouter) => Promise<void>;
	patchTemporal: (data: IMetadatosState, router?: NextRouter) => Promise<void>;
...
const useMetadatos = create<IMetadatosState & IMetadatatosActions>()(
	persist(
		(set, get) => ({
			...
			postMetadato: async (data: IMetadatosState, router?: NextRouter) =>
				await api.post("metadatos/create", data, {}, router),
			patchMetadato: async (data: IMetadatosState, router?: NextRouter) =>
				await api.patch(`metadatos/${data.id}`, data, {}, router),
			...
			postTemporal: async (data: IMetadatosState) =>
				await api.post("metadatos/temporal/create", data, {}, router),
			patchTemporal: async (data: IMetadatosState) =>
				await api.patch(`metadatos/temporal/${data.uid}`, data, {}, router),
