...
export default function ErrorPage() {
	return (
		<div className="container container-fluid text-center px-5 mt-3">
			...
			<p>
				La página o ruta especifcada puede que se encuentre en cualquiera de
				estos estatus:
			</p>
			...
			<h4>
				The server refuses the attempt to brew coffee with a teapot, or the
				requested entity body is short and stout.
			</h4>
			<img
				src={teaPot}
				width="200"
			...
			/>
			<p className="mb-5">
				Error reference for Hyper Text Coffee Pot Control Protocol
			</p>
		</div>
	);
}
