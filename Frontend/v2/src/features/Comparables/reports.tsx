...
const Cedula = ({ data }) => {
	const terreno = data?.find(({ tipo }) => tipo.toUpperCase() === "TERRENO");
	const renta = data?.find(({ tipo }) => tipo.toUpperCase() === "RENTA");
	const venta = data?.find(({ tipo }) => tipo.toUpperCase() === "VENTA");
...
const BaseMercado = ({ tipo, index, data }) => (
