					...
					(
						...
						<View style={styles.table} key={`${index}-${tipo}-${idx}`}>
							...
							<View style={styles.row}>
								...
								<Text style={styles.cellM} />
								<Text style={styles.cellN} />
								<Text style={{ ...styles.cellO, ...styles.bold }}>{registro}</Text>
								<Text style={styles.cellP} />
								<Text style={styles.cellQ} />
							</View>
							<View style={styles.row}>
								<Text style={styles.cellA} />
								<img style={styles.image} src={imagen_1} />
								<Text style={styles.cellI} />
								<img style={styles.image} src={imagen_2} crossOrigin="anonymous" />
								<Text style={styles.cellQ} />
							</View>
							<View style={styles.row}>
								<Text style={styles.cellA} />
								<Text style={{ ...styles.cellMiddle, ...styles.textCenter }}>
									Comparable 1
								</Text>
								<Text style={styles.cellI} />
								<Text style={{ ...styles.cellMiddle, ...styles.textCenter }}>
