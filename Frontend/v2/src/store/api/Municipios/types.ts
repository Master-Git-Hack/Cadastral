...
const translate = ({
	...
	porcentaje,
	viviendas_habitadas,
}: IIndicador): IIndicator => ({
	id,
	annualCensus: anualidad_censo,
	name: municipio,
	economicallyActivePopulation: pob_econom_activa,
	inhabitedDwellings: viviendas_habitadas,
...
export interface IDepartamentoSolicitante {
	id: number;
	descripcion: string;
	nombre_corto: string;
	secretaria: string;
