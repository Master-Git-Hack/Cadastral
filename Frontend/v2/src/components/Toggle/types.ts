...
export const variants = cva(
	"bg-gray-200 rounded-full peer peer-focus:ring-4 dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute  after:bg-white after:border-gray-300 after:border after:rounded-full  after:transition-all dark:border-gray-600",
	{
		variants: {
			variant: {
				default:
					"peer-checked:bg-gray-600 peer-focus:ring-gray-300 dark:peer-focus:ring-gray-800",
				primary:
				...
				light:
					"peer-focus:ring-gray-300 dark:peer-focus:ring-gray-800  peer-checked:bg-gray-600",
				dark: "peer-focus:ring-gray-300 dark:peer-focus:ring-gray-800  peer-checked:bg-gray-600",
			},
			size: {
				default:
					"w-11 h-6  after:top-[2px] after:left-[2px] after:h-5 after:w-5",
