...
export const variantsArea = cva("block rounded-lg text-sm", {
	variants: {
		variant: {
			...
			light: "text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200  dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700 dark:bg-white",
			success:
			...
			danger: "focus:outline-none text-gray-900 dark:text-white focus:ring-4 focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800 dark:bg-white",
