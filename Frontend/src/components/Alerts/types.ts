...
export interface IAlert extends SweetAlertOptions {
	icon?: SweetAlertIcon;
	isLoading?: boolean;
	confirmColor?: "default" | "primary" | "secondary" | "outline" | "dark" | "light" | "success" | "warning" | "danger" | "info";
	cancelColor?:"default" | "primary" | "secondary" | "outline" | "dark" | "light" | "success" | "warning" | "danger" | "info";
