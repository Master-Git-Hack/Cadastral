...
export function Table(props: any) {
      ...
      {new URLSearchParams(window.location.search)
        ...
        <tfoot>
          ...
          <tr>
            ...
            <td className="text-center" colSpan={6} rowSpan={1}>
              <strong>
                {toFancyNumber(
                  roundToTenth(props.averageUnitValue),
                  true,
                  false,
                  2
                )}
        ...
        <tfoot>
          <tr>
            ...
            <td
              colSpan={props.headerForFactors.length - 2}
              rowSpan={2}
              className="text-start"
            >
              m<sup>2</sup>
  ...
  return (
    <table className="table table-sm table-responsive table-responsive-sm table-striped table-borderless table-hover">
      <thead>
        <HeadersBegin {...props} />
