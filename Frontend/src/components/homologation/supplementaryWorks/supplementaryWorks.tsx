/** @format */
import { request } from "../../../features/homologation/slice";
import {
	getState,
	addRowSupplementary,
...
export default function SupplementaryWorksComponent() {
	const { status, supplementaryWorks } = useAppSelector(getState);
	const { data, total, options, errors } = supplementaryWorks;
	...
	return (
		<div className="container container-fluid" ref={pageReference}>
