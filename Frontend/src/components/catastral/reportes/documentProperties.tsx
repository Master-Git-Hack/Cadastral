...
import { Header, Table, Body as TBody, Footer } from "../../table/Table";

export const X = (props: { saveButton: any }) => {
	...
	return (
		<Table>
				...
				<tr>
					<th className="text-start">
						...
						>
							...
							<img src={fileAdd} alt="file" className="mb-1 bg-primary text-light" />
						</button>
					</th>
			...
			<TBody>
				<DocumentProperties data={reports} dispatch={dispatch} />
			</TBody>
			<Footer>
				{reports.length > 1 && (
					<tr>
...
export const DocumentProperties = (props: { data: any; dispatch: Function }) =>
								...
								<div className="col">
									<div className="form-floating form-floating-sm">
										...
										<label htmlFor="floatingInput-Margin-Bottom">
											Inferior:{" "}
											<strong>{item.moreProperties.margins.bottom}</strong>
										</label>
									</div>
								</div>
							</div>
