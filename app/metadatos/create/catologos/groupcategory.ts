...
export const groupcategory = [
	{
		label: "Grupo de datos de recursos naturales y clima",
		description:
	...
	{
		label: "Grupo de datos de nombres geográficos",
		description:
	...
	{
		label: "Grupo de datos catastrales",
		description:
	...
	{
		label: "Grupo de datos topográficos",
		description:
	...
	{
		label: "Grupo de datos de relieve continental, insular y submarino",
		description:
	...
	{
		label: "Grupo de datos del marco de referencia geodésico",
		description:
			"Subdivisión de la Infraestructura de Datos Espaciales de México que contiene datos referidos a los sistemas de referencia para la ubicación geográfica de puntos de las redes geodésicas horizontal, vertical y gravimétric establecidos sobre el territorio nacional. Este Grupo de Datos es fundamental para la georreferencia de todos los demás Grupos de Datos",
		code: "7",
	},
];
