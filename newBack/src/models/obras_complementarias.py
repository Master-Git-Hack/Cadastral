"""
Handle everything related to the ObrasComplementarias model
Define the ObrasComplementarias model.
Define the ObrasComplementarias schema.
Define the ObrasComplementarias crud.
Export the ObrasComplementarias model.
"""
...
class _ObrasComplementarias(Base):
    """Model for ObrasComplementarias.
    Example:
        >>> ObrasComplementarias(data:dict)
    Args:
...
class _Read:
    ...
    async def all(
    ...
    ) -> _ObrasComplementarias or _Schema or None:
        """
        ...
        """
        try:
            response = db.session.query(_ObrasComplementarias).all()
            if to_list:
    ...
    async def by_id(
        ...
        """
        try:
            response = db.session.query(_ObrasComplementarias).get(_id)
            if to_dict:
...
class ObrasComplementarias:
    ...
    async def create(
    ...
    ) -> Tuple[bool, _ObrasComplementarias or _Schema or None]:
        """
        ...
        """
        try:
            new = _ObrasComplementarias(data)
            db.session.add(new)
            db.session.commit()
...
and return a tuple with the results
        ...
        """
        current_entity = db.session.query(_ObrasComplementarias).get(_id)
    ...
    @staticmethod
    def to_dict(
        entity: _ObrasComplementarias, exclude: Optional[list] = None
    ) -> _Schema:
    ...
    @staticmethod
    def to_list(
        entities: _ObrasComplementarias, exclude: Optional[list] = None
    ) -> list:
        """Pass a model instance to a dict
        Args:
