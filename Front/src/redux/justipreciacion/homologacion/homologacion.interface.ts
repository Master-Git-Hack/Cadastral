...
export interface InitialStateProps extends Properties {
...
const { factors, documentation, handlers } = homologacion;
const {
	age,
	building,
	classification,
...
const { area, indiviso, reFactor, salesCost, weightingPercentage } = documentation;
...
export const initialState = (type: string, appraisalPurpose: string): InitialStateProps => ({
	...
	documentation: {
		Area: area.initialState(type),
		SalesCost: salesCost.initialState(type),
		WeightingPercentage: weightingPercentage.initialState,
		ReFactor: reFactor.initialState(type),
		Indiviso: indiviso.initialState(type),
		observations: "",
	},
	errors: [],
	record: {
