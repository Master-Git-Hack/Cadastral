...
ADD COLUMN inf_metadata_ci_responsibleparty_individualname TEXT,
ADD COLUMN inf_metadata_ci_responsibleparty_deliverypoint TEXT,
ADD COLUMN inf_metadata_ci_responsibleparty_city TEXT,
ADD COLUMN inf_metadata_ci_responsibleparty_postalcode TEXT,
ADD COLUMN inf_metadata_ci_responsibleparty_country TEXT,
ADD COLUMN inf_metadata_ci_responsibleparty_electronicmailaddress TEXT,
ADD COLUMN inf_metadata_ci_responsibleparty_positionname TEXT,
ADD COLUMN inf_metadata_ci_responsibleparty_voice TEXT,
