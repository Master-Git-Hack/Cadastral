...
class Schema(BaseModel):
    ...
    oficio_solicitud: Optional[str]
    fecha_solicitud: Optional[date]
    objetivo_avaluo: Optional[str]
    proposito_avaluo: Optional[str]
    inmueble_valua: Optional[str]
    ubicacion: Optional[str]
    colonia_poblacion: Optional[str]
    municipio: Optional[str]
    propietario: Optional[str]
    x_utm: Optional[float]
    y_utm: Optional[float]
    zona_utm: Optional[int]
    cuenta_predial: Optional[str]
    cuc: Optional[str]
    clasificacion_zona: Optional[str]
    agua: Optional[int]
    drenaje: Optional[int]
    energia_electrica: Optional[int]
    telefonia: Optional[int]
    tipo_pavimento: Optional[str]
    alumbrado_publico: Optional[int]
    banqueta: Optional[int]
    indice_saturacion: Optional[str]
    ...
    col4: Optional[str]
    med4: Optional[str]
    sp1_superficie: Optional[float]
    sp1_vu: Optional[float]
    sp1_factor: Optional[float]
    sp1_valor_parcial: Optional[float]
    sp2_superficie: Optional[float]
    sp2_vu: Optional[float]
    sp2_factor: Optional[float]
    sp2_valor_parcial: Optional[float]
    sp3_superficie: Optional[float]
    sp3_vu: Optional[float]
    sp3_factor: Optional[float]
    sp3_valor_parcial: Optional[float]
    sp4_superficie: Optional[float]
    sp4_vu: Optional[float]
    sp4_factor: Optional[float]
    sp4_valor_parcial: Optional[float]
    incr_esq_superficie: Optional[float]
    incr_esq_vu: Optional[float]
    incr_esq_factor: Optional[float]
    incr_esq_valor_parcial: Optional[float]
    sup_total_terreno: Optional[float]
    valor_total_terreno: Optional[float]
    uso_dominante: Optional[str]
    tipo_constr_dominante: Optional[str]
    muros: Optional[str]
    estructura: Optional[str]
    entrepisos: Optional[str]
    techos: Optional[str]
    pisos: Optional[str]
    puertas: Optional[str]
    ventanas: Optional[str]
