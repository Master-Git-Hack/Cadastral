...
class Controller:
    ...
    def __init__(self, collection = None, year = None, start = None, end = None, zoom = 1, page_size = 'A4', margins = {
        'top': 10,
        'bottom': None,
        'left': None,
        'right': None,
    ...
    def merge_reports(self, collection=[], filename=temporary_filename(extension='pdf')):
        reports = PDF()
