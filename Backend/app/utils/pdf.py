...
class PDF:
            ...
            with open(file, "w") as file:
                file.write(
                    _template.render(
                        ...
                        OFICIO_DE_SOLICITUD=item_validator(
                            document[0]["oficio_solicitud"]
                        ),
                        FECHA_DE_SOLICITUD=item_validator(
                            asCompleteDate(document[0]["fecha_solicitud"])
                        ),
                        ADQUIRIENTE=item_validator(document[0]["adquiriente"]),
                        OBJETIVO_DEL_AVALUO=item_validator(
                            document[0]["objetivo_avaluo"]
                        ),
                        PROPOSITO_DEL_AVALUO=item_validator(
                            document[0]["proposito_avaluo"]
                        ),
                        INMUEBLE_QUE_SE_AVALUA=item_validator(
                            document[0]["inmueble_valua"]
                        ),
                        ZONA_UTM=item_validator(document[0]["zona_utm"]),
                        CALLE=item_validator(document[0]["calle"]),
                        NUMERO=item_validator(document[0]["numero"]),
                        COLONIA_O_POBLACION=item_validator(
                            document[0]["colonia_poblacion"]
                        ),
                        MUNICIPIO=item_validator(document[0]["nombre_utf"].upper()),
                        COORDENADAS_EN_X=withDecimals(
                            item_validator(document[0]["x_utm"]), 0
                        ),
                        COORDENADAS_EN_Y=withDecimals(
                            item_validator(document[0]["y_utm"]), 0
                        ),
                        ...
                        CLASIFICACION_DE_ZONA=item_validator(
                            document[0]["clasificacion_zona"]
                        ),
                        USO_DOMINANTE=item_validator(document[0]["uso_dominante"]),
                        TIPO_DE_CONSTRUCCION_DOMINANTE=item_validator(
                            document[0]["tipo_constr_dominante"]
                        ),
                        ...
                        INDICE_DE_SATURACION=asPercentage(
                            document[0]["indice_saturacion"]
                        ),
                        ...
                        INSTALACION_ELECTRICA=item_validator(
                            document[0]["inst_electrica"]
                        ),
                        ...
                        INSTALACION_SANITARIA=item_validator(
                            document[0]["inst_sanitaria"]
                        ),
                        ...
                        ACABADO_EXTERIOR=item_validator(
                            document[0]["acabado_exterior"]
                        ),
                        ...
                        MUEBLES_SANITARIOS=item_validator(
                            document[0]["muebles_sanitarios"]
                        ),
                        ORIENTACION6=item_validator(document[0]["col6"]),
                        MEDIDAS_ORIENTACION6=item_validator(document[0]["med6"]),
                        SUPERFICIE_TERRENO1=withDecimals(
                            item_validator(document[0]["sp1_superficie"]), 3
                        ),
                        VALOR_UNITARIO_TERRENO1=asCurrency(document[0]["sp1_vu"]),
                        FACTOR_TERRENO1=item_validator(document[0]["sp1_factor"]),
                        VALOR_PARCIAL_TERRENO1=asCurrency(
                            item_validator(document[0]["sp1_valor_parcial"])
                        ),
                        ...
                        CNA_SUPERFICIE=withDecimals(
                            item_validator(document[0]["cna_superficie"]), 2
                        ),
                        CNA_VALOR_UNITARIO=asCurrency(
                            item_validator(document[0]["cna_vu"])
                        ),
                        CNA_VALOR_PARCIAL=asCurrency(
                            item_validator(document[0]["cna_valor_parcial"])
                        ),
                        SUPERFICIE_TERRENO2=withDecimals(
                            item_validator(document[0]["sp2_superficie"]), 2
                        ),
                        VALOR_UNITARIO_TERRENO2=asCurrency(
                            item_validator(document[0]["sp2_vu"])
                        ),
                        FACTOR_TERRENO2=item_validator(document[0]["sp2_factor"]),
                        VALOR_PARCIAL_TERRENO2=asCurrency(
                            document[0]["sp2_valor_parcial"]
                        ),
                        ...
                        CNB_SUPERFICIE=withDecimals(
                            item_validator(document[0]["cnb_superficie"]), 2
                        ),
                        CNB_VALOR_UNITARIO=asCurrency(
                            item_validator(document[0]["cnb_vu"])
                        ),
                        CNB_VALOR_PARCIAL=asCurrency(
                            item_validator(document[0]["cnb_valor_parcial"])
                        ),
                        SUPERFICIE_TERRENO3=withDecimals(
                            item_validator(document[0]["sp3_superficie"]), 2
                        ),
                        VALOR_UNITARIO_TERRENO3=asCurrency(
                            item_validator(document[0]["sp3_vu"])
                        ),
                        FACTOR_TERRENO3=item_validator(document[0]["sp3_factor"]),
                        VALOR_PARCIAL_TERRENO3=asCurrency(
                            item_validator(document[0]["sp3_valor_parcial"])
                        ),
                        ...
                        CNC_SUPERFICIE=withDecimals(
                            item_validator(document[0]["cnc_superficie"]), 2
                        ),
                        CNC_VALOR_UNITARIO=asCurrency(
                            item_validator(document[0]["cnc_vu"])
                        ),
                        CNC_VALOR_PARCIAL=asCurrency(
                            item_validator(document[0]["cnc_valor_parcial"])
                        ),
                        SUPERFICIE_TERRENO4=withDecimals(
                            item_validator(document[0]["sp4_superficie"]), 2
                        ),
                        VALOR_UNITARIO_TERRENO4=asCurrency(
                            item_validator(document[0]["sp4_vu"])
                        ),
                        FACTOR_TERRENO4=item_validator(document[0]["sp4_factor"]),
                        VALOR_PARCIAL_TERRENO4=asCurrency(
                            item_validator(document[0]["sp4_valor_parcial"])
                        ),
                        ...
                        CND_SUPERFICIE=withDecimals(
                            item_validator(document[0]["cnd_superficie"]), 2
                        ),
                        CND_VALOR_UNITARIO=asCurrency(
                            item_validator(document[0]["cnd_vu"])
                        ),
                        CND_VALOR_PARCIAL=asCurrency(
                            item_validator(document[0]["cnd_valor_parcial"])
                        ),
                        INCREMENTO_ESQUINA_SUPERFICIE=withDecimals(
                            item_validator(document[0]["incr_esq_superficie"]), 2
                        ),
                        INCREMENTO_ESQUINA_VALOR_UNITARIO=asCurrency(
                            item_validator(document[0]["incr_esq_vu"])
                        ),
                        INCREMENTO_ESQUINA_FACTOR=item_validator(
                            document[0]["incr_esq_factor"]
                        ),
                        INCREMENTO_ESQUINA_VALOR_PARCIAL=asCurrency(
                            item_validator(document[0]["incr_esq_valor_parcial"])
                        ),
                        SUPERFICIE_TOTAL_TERRENO=withDecimals(
                            item_validator(document[0]["sup_total_terreno"]), 3
                        ),
                        VALOR_TOTAL_TERRENO=asCurrency(
                            item_validator(document[0]["valor_total_terreno"])
                        ),
                        SUPERFICIE_TOTAL_CONSTRUCCION=withDecimals(
                            item_validator(document[0]["sup_total_construccion"]), 2
                        ),
                        VALOR_TOTAL_CONSTRUCCION=asCurrency(
                            item_validator(document[0]["valor_total_construccion"])
                        ),
                        REGISTRO=item_validator(document[0]["registro"]),
                        VALOR_TOTAL_CATASTRAL=asCurrency(
                            item_validator(document[0]["vt_catastral"])
                        ),
                        ...
                        DOMICILIO_GEOGRAFICO=item_validator(
                            document[0]["domicilio_geografico"]
                        ),
                        OBSERVACIONES=item_validator(document[0]["observaciones"]),
                        FECHA_EMISION=asCompleteDate(
                            item_validator(document[0]["fecha_emision"])
                        ),
    ...
    def create(
        self, collection, filename=temporary_filename(extension="pdf"), watermark=False
    ):
