...
def get_registro(id: int, db: Session) -> Responses:
    """
...
def get_valor_especifico(id: int, key: str, db: Session) -> Responses:
    """
...
def patch_by_homologacion(id: int, tipo: str, data: dict, db: Session) -> Responses:
    """
...
def patch_by_obras_complementarias(id: int, data: dict, db: Session) -> Responses:
    """
...
def patch_by_costos_construccion(id: int, data: dict, db: Session) -> Responses:
    """
    Update Justipreciacion from an obras complementarias request
    Args:
        _id (int): ID
