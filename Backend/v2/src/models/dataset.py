...
class Model(database.BASE):
    ...
    geometry_type = Column(Text, nullable=True)
    ...
    abstract = Column(Text, nullable=False, comment="1.3	Resumen (O)")
    md_dataidentification_language = Column(
    ...
    ci_onlineresource_description = Column(
        Text,
        nullable=True,
    ...
    ci_responsibleparty_voice = Column(
        Text,
        nullable=True,
        comment="3.4	Teléfono (Opc, repetible) | 9.4.4	Teléfono (Opc, repetible)",
    )
    ci_responsibleparty_administrativearea = Column(
        Text,
        nullable=True,
    ...
    utm_feast = Column(Float, nullable=True, comment="5.1.2.2.1.5 Falso este")
    utm_fnorth = Column(Float, nullable=True, comment="5.1.2.2.1.6 Falso norte")
    horizdn = Column(Text, nullable=True, comment="5.1.4.1 Nombre del datum horizontal")
    ellips = Column(Text, nullable=True, comment="5.1.4.2 Nombre del elipsoide")
    semiaxis = Column(Float, nullable=True, comment="5.1.4.3 Semieje mayor")
    denflat = Column(
        Float, nullable=True, comment="5.1.4.4 Factor de denominador de achatamiento"
    )
    level = Column(
        Text,
        nullable=True,
    ...
    inf_metadata_ci_responsibleparty_organisationname = Column(
        Text,
        nullable=True,
    ...
    ci_responsibleparty_city = Column(
        Text,
        nullable=True,
        default="Guanaajuato",
        comment="9.4.7	Ciudad (Opc)",
    )
    ci_responsibleparty_postalcode = Column(
        Text,
        nullable=True,
        comment="9.4.9	Código postal (Opc)",
    )
    ci_responsibleparty_country = Column(
        Text, comment="9.4.10	País (Opc)", default="México"
    )
    ci_responsibleparty_electronicmailaddress = Column(
        Text,
        nullable=True,
        comment="9.4.11	Dirección de correo electrónico del contacto (Opc, repetible)",
    )
    inf_metadata_ci_responsibleparty_role = Column(
        Text,
        nullable=True,
