"""
Handle everything related to the IndicadoresMunicipales model
Define the IndicadoresMunicipales model.
Define the IndicadoresMunicipales schema.
Define the IndicadoresMunicipales crud.
Export the IndicadoresMunicipales model.
"""
...
class _IndicadoresMunicipales(Base):
    """Model for IndicadoresMunicipales.
    Example:
        >>> IndicadoresMunicipales(data:dict)
    Args:
...
class _Read:
    ...
    async def all(
    ...
    ) -> _IndicadoresMunicipales or _Schema or None:
        """
        ...
        """
        try:
            response = db.session.query(_IndicadoresMunicipales).all()
            if to_list:
    ...
    async def by_id(
        ...
        """
        try:
            response = db.session.query(_IndicadoresMunicipales).get(_id)
            if to_dict:
...
class IndicadoresMunicipales:
    ...
    async def create(
    ...
    ) -> Tuple[bool, _IndicadoresMunicipales or _Schema or None]:
        """
        ...
        """
        try:
            new = _IndicadoresMunicipales(data)
            db.session.add(new)
            db.session.commit()
...
and return a tuple with the results
        ...
        """
        current_entity = db.session.query(_IndicadoresMunicipales).get(_id)
    ...
    @staticmethod
    def to_dict(
        entity: _IndicadoresMunicipales, exclude: Optional[list] = None
    ) -> _Schema:
    ...
    @staticmethod
    def to_list(
        entities: _IndicadoresMunicipales, exclude: Optional[list] = None
    ) -> list:
        """Pass a model instance to a dict
        Args:
