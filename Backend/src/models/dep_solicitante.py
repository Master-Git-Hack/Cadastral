"""
Handle everything related to the DepSolicitante model
Define the DepSolicitante model.
Define the DepSolicitante schema.
Define the DepSolicitante crud.
Export the DepSolicitante model.
"""
...
class _DepSolicitante(Base):
    """
    Departamentos Solicitantes
    Model for DepSolicitante.
    Example:
        >>> DepSolicitantes(data:dict)
    Args:
...
class _Read:
    ...
    ) -> _DepSolicitante or _Schema or None:
        """
    ...
    async def by_id(
        ...
        """
        try:
            response = db.session.query(_DepSolicitante).get(_id)
            if to_dict:
...
class DepSolicitante:
    ...
    ) -> Tuple[bool, _DepSolicitante or _Schema or None]:
        """
...
and return a tuple with the results
        ...
        """
        current_entity = db.session.query(_DepSolicitante).get(_id)
    ...
    @staticmethod
    def to_dict(entity: _DepSolicitante, exclude: Optional[list] = None) -> _Schema:
    ...
    @staticmethod
    def to_list(entities: _DepSolicitante, exclude: Optional[list] = None) -> list:
        """Pass a model instance to a dict
        Args:
