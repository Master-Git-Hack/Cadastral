			...
			>
				...
				<DropdownItem
					...
					startContent={
						<span
							key="light-dark-icon"
							className="animate-pulse hover:motion-safe:animate-spin size-[1.2rem] me-2"
						>
							{isDark ? (
				...
				>
					...
					>
						{isDark ? "Deshabilitar " : "Habilitar "} Tema Oscuro
					</div>
				</DropdownItem>
				...
				<DropdownSection showDivider>
					<DropdownItem
						key="logout"
						className="hover:text-red-600 hover:bg-red-400 text-red-300  rounded-lg "
						startContent={
							<span className="animate-pulse pi pi-sign-out me-2" />
						}
						onPress={() => {
							signOut();
							router.push("/sign-in");
